...
function buildAppUrl(basePath, pathname) {
  return `${normalizeBasePath(basePath)}/${String(pathname).replace(/^\/+/, "")}`;
}
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      console.error("Diagnostic report delivery failed:", error.message);
    }
    ...
    const payload = {
      ...
      biggest_risk_area: score.biggestRiskArea,
      recommended_fixes: score.recommendedFixes,
