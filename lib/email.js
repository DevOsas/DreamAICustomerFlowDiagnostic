...
function getFromEmail() {
  return process.env.FROM_EMAIL || "Infinity Think <no-reply@example.com>";
}
...
Your Infinity Think AI Revenue Diagnostic Report is attached.

It shows where your business may be losing leads, bookings, and revenue - and which AI workflows to deploy first.

After reviewing it, you can book your free Infinity Think AI Revenue Audit here:
${bookingLink}
...
Infinity Think`;
  ...
  return sendEmail({
    to: prospect.email,
    subject: "Your Infinity Think AI Revenue Diagnostic Report",
    text,
...
async function sendAdminNotification({ prospect, score, answers, bookingLink }) {
  ...
  const text = `New Infinity Think AI Revenue Diagnostic Submission
...
${JSON.stringify(answers, null, 2)}`;
  ...
  return sendEmail({
    ...
    subject: "New Infinity Think AI Revenue Diagnostic Submission",
    text,
