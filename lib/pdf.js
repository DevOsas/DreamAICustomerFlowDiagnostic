...
function generateDiagnosticPdf({ prospect, score, bookingLink }) {
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .fontSize(10)
      .font("Helvetica-Bold")
      .text("DREAM AI SALES ENGINE", 55, 36, { letterSpacing: 0.5 });
    doc
      .fillColor("#FFFFFF")
      .fontSize(25)
      .font("Helvetica-Bold")
      .text("Your AI Sales Pipeline Diagnostic Report", 55, 56, { width: 440 });
    doc
      .fillColor("#CBD5E1")
      .fontSize(10.5)
      .font("Helvetica")
      .text("AI agents that prospect, follow up, book calls, and close deals - 24/7.", 55, 94);
    ...
    doc
      ...
      .font("Helvetica")
      .text(
        "More leads alone won't fix pipeline leakage. AI agents will. Your score shows how AI-ready your current sales pipeline is across prospecting, capture, response, follow-up, booking, conversion, and retention.",
        { lineGap: 3 }
      );
    ...
    addSectionTitle(doc, "Recommended AI Agents");
    ...
    addSectionTitle(doc, "Book Your Free AI Sales Audit");
    doc
      .fillColor(COLORS.ink)
      .fontSize(11)
      .font("Helvetica")
      .text("On this free audit, we'll review your score, identify your biggest pipeline leak, and show you which AI agents to deploy first.", { lineGap: 3 });
    doc.moveDown(0.5);
    ...
    doc
      ...
      .fontSize(9.5)
      .font("Helvetica")
      .text("Dream AI Sales Engine - AI agents that prospect, follow up, book calls, and close deals - 24/7.", 55, 761, { width: 500, align: "center" });
